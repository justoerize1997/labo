...
param  <- list( "num.trees"=       1883,  #cantidad de arboles
                "mtry"=             28,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  427,  #tamaño minimo de las hojas
                "max.depth"=        20   # 0 significa profundidad infinita
              )

set.seed(1226976) #Establezco la semilla aleatoria
