...
loguear  <- function( reg, arch=NA, folder="./exp/", ext=".csv", verbose=TRUE )
{
  archivo  <- arch
...
setwd("C:\\Users\\upier\\OneDrive\\Desktop\\Posgrado\\MinDatos\\labo\\exp\\HT5430")   #Establezco el Working Directory DEL EXPERIMENTO
